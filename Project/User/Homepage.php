...
<style>
  ...
  <body>
        ...
        <div class="row py-3 border-bottom">
          ...
          <div class="col-lg-4">
            <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
              ...
              <li class="nav-item active">
                <a href="ViewShops.php" class="nav-link">Shops</a>
              </li>
              <li class="nav-item active">
                <a href="MyBookings.php" class="nav-link">Bookings</a>
              </li>
              <li class="nav-item active">
          ...
          <div class="col-sm-8 col-lg-2 d-flex gap-5 align-items-center justify-content-center justify-content-sm-end">
            <ul class="d-flex justify-content-end list-unstyled m-0">
              <li>
                <a href="Myprofile.php" class="p-2 mx-1">
                  <svg width="24" height="24"><use xlink:href="#user"></use></svg>
                </a>
              </li>
              <li>
                <a href="MyBookings.php" class="p-2 mx-1">
                  <svg width="24" height="24"><use xlink:href="#wishlist"></use></svg>
                </a>
              </li>
              <li>
                <a href="Complaint.php" class="p-2 mx-1">
    ...
    <section style="background-image: url('../Assets/Templates/User/images/userbg.png');background-repeat: no-repeat;background-size: cover;">
        ...
        <div class="row">
          <div class="col-lg-6 pt-5 mt-5">
            ...
            <div class="d-flex gap-3">
              <a href="ViewShops.php" class="btn btn-primary text-uppercase fs-6 rounded-pill px-4 py-3 mt-5">SHOP NOW</a>
            </div>
            ...
            <div class="banner-ad d-flex align-items-center large bg-info block-1" style="background: url('../Assets/Templates/User/images/banner 1.jpg') no-repeat; background-size: cover;">
                <div class="banner-content p-5">
                  <div class="content-wrapper text-light">
                    ...
                    <a href="ViewShops.php" class="btn-link text-white">Shop Now</a>
                  </div>
                </div>
              </div>
