...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="Assets/Templates/User/css/vendor.css">
    <link rel="stylesheet" type="text/css" href="Assets/Templates/User/style.css">
...
<style>
  ...
  <body>
        ...
        <div class="row py-3 border-bottom">
          ...
          <div class="col-lg-4">
            <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
              ...
              <li class="nav-item active">
                <a href="Guest/Aboutus.php" class="nav-link">About US</a>
              </li>
              <li class="nav-item active">
          ...
          <div class="col-sm-8 col-lg-2 d-flex gap-5 align-items-center justify-content-center justify-content-sm-end">
            <ul class="d-flex justify-content-end list-unstyled m-0">
              ...
              <li>
                <a href="Guest/Usersignup.php" class="btn btn-primary text-uppercase fs-6 rounded-pill px-4 py-2 mt-1">Sign Up</a>
              </li>
    ...
    <section style="background-image: url('Assets/Templates/User/images/background.jpg');background-repeat: no-repeat;background-size: cover;">
      <div class="container-lg">
        <div class="row">
          <div class="col-lg-6 pt-5 mt-5">
            <h2 class="display-1 ls-1"><span class="fw-bold montserrat text-white">Smart</span><span class="montserrat text-white"> way to buy </span><span class="fw-bold montserrat text-white">Ration</span></h2>
            <p class="fs-4 montserrat text-white">Your Ration,Anywhere.</p>
            <div class="d-flex gap-3">
              <a href="Guest/Login.php" class="btn btn-primary text-uppercase fs-6 rounded-pill px-4 py-3 mt-5">SHOP NOW</a>
              <a href="Guest/Login.php" class="btn btn-dark text-uppercase fs-6 rounded-pill px-4 py-3 mt-5">Login</a>
            </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="banner-blocks">
              ...
              <div class="banner-ad d-flex align-items-center large bg-info block-1" style="background: url('Assets/Templates/User/images/banner 1.jpg') no-repeat; background-size: cover;">
                <div class="banner-content p-5">
                  <div class="content-wrapper text-light">
                    <h3 class="banner-title text-light">Buy Wheat</h3>
                    <p>Discount 30% on AAY Card</p>
                    <a href="Guest/Login.php" class="btn-link text-white">Shop Now</a>
                  </div>
                </div>
              </div>
              
              <div class="banner-ad bg-success-subtle block-2" style="background:url('Assets/Templates/User/images/banner2.jpg') no-repeat;background-size: cover">
                <div class="banner-content align-items-center p-5">
                  <div class="content-wrapper text-light">
                    <h3 class="banner-title text-light">Kerosene price increase $2</h3>
                    <p>Discounts 5% on APL(priority) & AAY Cards</p>
                    <a href="Guest/Login.php" class="btn-link text-white">Shop Now</a>
                  </div>
                </div>
              </div>

              <div class="banner-ad bg-danger block-3" style="background:url('Assets/Templates/User/images/banner3.png') no-repeat;background-size: cover">
                <div class="banner-content align-items-center p-5">
                  <div class="content-wrapper text-light">
                    <h3 class="banner-title text-light">5% Discout on Rice for all Cards</h3>
    ...
    <section>
      <div class="container-lg">
        ...
        <div class="bg-secondary text-light py-5 my-5" style="background: url('Assets/Templates/User/images/banner4.png') no-repeat; background-size: cover;">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-md-5 p-3">
                <div class="section-header">
                  <h2 class="section-title display-5 text-light">Get your Special Monthly Ration Kit</h2>
                </div>
                <p>Just Sign Up & Book it now </p>
                </div>
                <div class="col-md-5 p-3">
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="Assets/Templates/User/images/subad1.jpg" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                  <div class="meta-date"><svg width="16" height="16"><use xlink:href="#calendar"></use></svg>06 Oct 2024</div>
                </div>
                <div class="post-header">
                  <h3 class="post-title">
                    <a href="#" class="text-decoration-none text-dark ">Free Delivery For AYY Card Users</a>
                  </h3>
                  <p>All the Ration Products are delivered freee to the homes of AYY card users.</p>
                </div>
              </div>
            </article>
          </div>
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="Assets/Templates/User/images/subad2.jpg" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                  <div class="meta-date"><svg width="16" height="16"><use xlink:href="#calendar"></use></svg>25 Oct 2024</div>
                </div>
                <div class="post-header">
                  <h3 class="post-title">
                    <a href="#" class="text-decoration-none text-dark">More Ration items are added to the supply</a>
                  </h3>
                  <p>By adding more ration items,the platform aims to provide a one-stop soliution for user's daily essentials</p>
                </div>
              </div>
            </article>
          </div>
          ...
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="Assets/Templates/User/images/subad3.jpg" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                  <div class="meta-date"><svg width="16" height="16"><use xlink:href="#calendar"></use></svg>28 Oct 2025</div>
                </div>
                <div class="post-header">
                  <h3 class="post-title">
                    <a href="#" class="text-decoration-none">Subsidy on Ration items</a>
                  </h3>
                  <p>Collaborate with the government to offer subsidies on ration items,making them more affordable for customers..</p>
                </div>
              </div>
            </article>
          </div>
        ...
        <div class="bg-warning pt-5 rounded-5">
          <div class="container">
            <div class="row justify-content-center align-items-center">
              <div class="col-md-4">
                <h2 class="mt-5 text-white">Download e-Ration App</h2>
                <p>Online Orders made easy, fast and reliable</p>
                <div class="d-flex gap-2 flex-wrap mb-5">
                  <a href="#" title="App store"><img src="Assets/Templates/User/images/img-app-store.png" alt="app-store"></a>
                  <a href="#" title="Google Play"><img src="Assets/Templates/User/images/img-google-play.png" alt="google-play"></a>
                </div>
              </div>
              <div class="col-md-5">
                <img src="Assets/Templates/User/images/banner-onlineapp.png" alt="phone" class="img-fluid">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer-menu">
              <img src="Assets/Templates/User/images/eration.png" width="240" height="70" alt="logo">
          ...
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              <h5 class="widget-title montserrat">products</h5>
              <ul class="menu-list list-unstyled">
                <li class="menu-item">
                  <a href="#" class="nav-link">wheat</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Rice </a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Kerosene</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">wheat flour</a>
                </li>
                <li class="menu-item">
          ...
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              <h5 class="widget-title montserrat">Quick Links</h5>
              <ul class="menu-list list-unstyled">
                <li class="menu-item">
          ...
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              <h5 class="widget-title montserrat">Customer Service</h5>
              <ul class="menu-list list-unstyled">
                <li class="menu-item">
    ...
    <script src="Assets/Templates/User/js/jquery-1.11.0.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous"></script>
    <script src="Assets/Templates/User/js/plugins.js"></script>
    <script src="Assets/Templates/User/js/script.js"></script>
  </body>
</html>