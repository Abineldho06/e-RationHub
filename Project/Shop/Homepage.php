...
<style>
  ...
  <body>
        ...
        <div class="row py-3 border-bottom">
          ...
          <div class="col-lg-4">
            <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
              ...
              <li class="nav-item active">
                <a href="ShopProduct.php" class="nav-link">Products</a>
              </li>
              <li class="nav-item active">
    ...
    <section style="background-image: url('../Assets/Templates/User/images/shopbg.jpg');background-repeat: no-repeat;background-size: cover;">
        ...
        <div class="row">
          <div class="col-lg-6 pt-5 mt-5">
            ...
            <div class="d-flex gap-3">
              <a href="ShopProduct.php" class="btn btn-primary text-uppercase fs-6 rounded-pill px-4 py-3 mt-5">Product</a>
            </div>
